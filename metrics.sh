...
metrics_ouput_data_root=/home/trunk/work/code/metricslidarperception/result/
...
sed -i -r 's%metrics_result_path: .*%metrics_result_path: '"\"${metrics_ouput_data_root}\""'%' $metrics_script_root/config/object_eval.yaml
